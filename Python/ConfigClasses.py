...
def test():
    ...
    config = ControllerConfiguration(0, DEFAULT_CFG_FILE, [[255, 0, 0], [0, 255, 0], [0, 0, 255], [50, 0, 50]], 32)
    ...
    config.addConfig(ButtonAsButton(BUTTON_IN_6, BUTTON_RTH))
    config.addConfig(ButtonAsButton(BUTTON_IN_7, BUTTON_RTH))
    config.addConfig(ButtonAsButton(BUTTON_IN_8, BUTTON_UP))
    config.addConfig(ButtonAsButton(BUTTON_IN_9, BUTTON_DOWN))
    config.addConfig(ButtonAsButton(BUTTON_IN_10, BUTTON_START))
    config.addConfig(ButtonAsButton(BUTTON_IN_11, BUTTON_BACK))
