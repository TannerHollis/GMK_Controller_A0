...
def test():
    ...
    config.addConfig(EncoderAsButton(ENCODER_SPEED_BASED, ENCODER_DIR_CLOCKWISE, AXIS_NON_INVERTED, 1.0, BUTTON_UP))
    config.addConfig(EncoderAsButton(ENCODER_SPEED_BASED, ENCODER_DIR_COUNTERCLOCKWISE, AXIS_NON_INVERTED, 1.0, BUTTON_DOWN))
